export default {
  ...
  "share.anonymous-warning.banner.description": "Dieses Share wurde ohne angemeldetes Konto erstellt. Jeder könnte diese Dateien hochgeladen haben – behandle und öffne sie mit derselben Vorsicht wie Dateien aus dem offenen Internet.",
  ...
  "share.modal.anonymous-warning.description": "Diese Datei stammt aus einem anonymen Share – jeder könnte sie hier ohne Identitätsprüfung hochgeladen haben. Behandle sie mit derselben Vorsicht wie Dateien aus dem offenen Internet: verwende sie nicht für finanzielle Zwecke und führe sie nicht als Code aus.",
