export default {
  ...
  "share.anonymous-warning.banner.title": "Anonymes Share",
  "share.anonymous-warning.banner.description": "Beim Erstellen dieses Shares war niemand angemeldet, es gibt also keinen verifizierten Absender. Die Dateien können Spam, Betrug oder Schadsoftware wie ein Virus sein. Lade sie nur herunter, wenn du weißt, wer dir diesen Link geschickt hat und warum.",
  ...
  "share.modal.anonymous-warning.title": "Dieses Share ist anonym",
  "share.modal.anonymous-warning.description": "Diese Datei kann jeder hochgeladen haben, und nichts bestätigt, wer dahintersteckt. Sie kann Spam, Betrug oder ein Phishing-Versuch sein, oder Schadsoftware wie ein Virus oder Ransomware. Öffne sie nur, wenn du weißt, wer dir diesen Link geschickt hat, und diese Datei erwartest. Führe sie niemals als Programm oder Skript aus, aktiviere keine Makros darin und vertraue keinen darin enthaltenen Zahlungsdaten, Rechnungen oder Login-Seiten.",
  "share.modal.anonymous-warning.button.countdown": "Download in {seconds}s",
  "share.modal.anonymous-warning.button.ready": "Herunterladen",
  ...
  "admin.config.share.warn-anonymous-shares": "Vor anonymen Shares warnen",
  "admin.config.share.warn-anonymous-shares.description": "Zeige Besuchern eine Warnung, wenn ein Share ohne angemeldetes Konto erstellt wurde, und verlange eine kurze Verzögerung vor dem Herunterladen der Dateien.",
  "admin.config.share.warn-anonymous-shares-for-logged-in-users": "Auch angemeldete Nutzer warnen",
  "admin.config.share.warn-anonymous-shares-for-logged-in-users.description": "Zeige die Warnung für anonyme Shares auch angemeldeten Nutzern, nicht nur anonymen Besuchern. Erfordert, dass die obige Einstellung aktiviert ist.",
  "admin.config.share.anonymous-warning-message": "Eigene Warnmeldung",
  "admin.config.share.anonymous-warning-message.description": "Überschreibe den eingebauten Warntext für anonyme Shares für eine bestimmte Sprache. Wird sowohl im Banner der Share-Seite als auch im Download-Bestätigungsfenster verwendet. Leer lassen, um die eingebaute Übersetzung zu behalten.",
