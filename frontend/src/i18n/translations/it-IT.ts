export default {
  ...
  "share.anonymous-warning.banner.description": "Questa condivisione è stata creata senza un account collegato. Chiunque potrebbe aver caricato questi file: trattali e aprili con la stessa cautela che useresti per file provenienti da internet.",
  ...
  "share.modal.anonymous-warning.description": "Questo file proviene da una condivisione anonima: chiunque potrebbe averlo caricato qui senza verifica dell'identità. Trattalo con la stessa cautela dei file provenienti da internet: non usarlo per scopi finanziari e non eseguirlo come codice.",
