export default {
  ...
  "share.anonymous-warning.banner.title": "Condivisione anonima",
  "share.anonymous-warning.banner.description": "Nessuno era collegato quando questa condivisione è stata creata, quindi il mittente non è verificato. Questi file possono essere spam, una truffa o software dannoso come un virus. Scaricali solo se sai chi ti ha mandato questo link e perché.",
  ...
  "share.modal.anonymous-warning.title": "Questa condivisione è anonima",
  "share.modal.anonymous-warning.description": "Chiunque potrebbe aver caricato questo file e nulla conferma la sua identità. Può essere spam, una truffa o un tentativo di phishing, oppure software dannoso come un virus o un ransomware. Aprilo solo se sai chi ti ha mandato questo link e ti aspettavi questo file. Non eseguirlo mai come programma o script, non attivare le sue macro e non fidarti mai di dati di pagamento, fatture o pagine di accesso che contiene.",
  "share.modal.anonymous-warning.button.countdown": "Scarica tra {seconds}s",
  "share.modal.anonymous-warning.button.ready": "Scarica",
  ...
  "admin.config.share.warn-anonymous-shares": "Avvisa per le condivisioni anonime",
  "admin.config.share.warn-anonymous-shares.description": "Mostra un avviso ai visitatori quando una condivisione è stata creata senza un account collegato, e richiedi un breve conto alla rovescia prima di scaricare i suoi file.",
  "admin.config.share.warn-anonymous-shares-for-logged-in-users": "Avvisa anche gli utenti collegati",
  "admin.config.share.warn-anonymous-shares-for-logged-in-users.description": "Mostra l'avviso di condivisione anonima anche agli utenti collegati, non solo ai visitatori anonimi. Richiede che l'impostazione sopra sia attivata.",
  "admin.config.share.anonymous-warning-message": "Messaggio di avviso personalizzato",
  "admin.config.share.anonymous-warning-message.description": "Sostituisci il testo di avviso integrato per le condivisioni anonime, per una lingua specifica. Usato sia nel banner della pagina di condivisione sia nella finestra di conferma del download. Lascia vuoto per mantenere la traduzione integrata.",
