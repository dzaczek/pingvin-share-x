export default {
  ...
  "share.anonymous-warning.banner.description": "Przy tworzeniu tego udostępnienia nikt nie był zalogowany, więc nadawca jest niezweryfikowany. Pliki mogą być spamem, oszustwem albo złośliwym oprogramowaniem, na przykład wirusem. Pobieraj je tylko wtedy, gdy wiesz, kto wysłał Ci ten link i po co.",
