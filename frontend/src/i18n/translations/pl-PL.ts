export default {
  ...
  "admin.shares.scan.failed":
    "Skan antywirusowy nieudany lub ClamAV niedostępny",
  ...
  "admin.shares.block.description":
    "Pliki zostają na serwerze, więc nadal możesz je zbadać, ale udostępnienie otworzą tylko administratorzy. Wszyscy pozostali, łącznie z właścicielem, zobaczą komunikat o nieznalezieniu.",
  ...
  "admin.shares.scan.rescan.started":
    "Skan zakolejkowany, status zmieni się po zakończeniu",
  ...
  "admin.shares.modal.delete-selected.description":
    "Czy na pewno chcesz usunąć zaznaczone udostępnienia?",
  "admin.shares.notify.bulk-delete-failed":
    "Nie udało się usunąć {failed} z {total} udostępnień, lista została odświeżona",
  // END /admin/shares
  ...
  "share.file.lookup.virustotal":
    "Sprawdź ten plik na VirusTotal po sumie sha256. Plik nigdzie nie jest wysyłany, sprawdzany jest tylko jego skrót, więc nieznany plik pokaże się jako nieodnaleziony.",
  "share.anonymous-warning.banner.title": "Udostępnienie anonimowe",
  "share.anonymous-warning.banner.description":
    "Przy tworzeniu tego udostępnienia nikt nie był zalogowany, więc nadawca jest niezweryfikowany. Pliki mogą być spamem, oszustwem albo złośliwym oprogramowaniem, na przykład wirusem. Pobieraj je tylko wtedy, gdy wiesz, kto wysłał Ci ten link i po co.",
  ...
  "share.modal.anonymous-warning.description":
    "Ten plik mógł tu wrzucić ktokolwiek i nic nie potwierdza jego tożsamości. Może to być spam, oszustwo lub próba wyłudzenia danych, albo złośliwe oprogramowanie, na przykład wirus lub ransomware. Otwieraj go tylko wtedy, gdy wiesz, kto wysłał Ci ten link, i spodziewasz się tego pliku. Nigdy nie uruchamiaj go jako programu ani skryptu, nie włączaj w nim makr i nie ufaj zawartym w nim danym do płatności, fakturom ani stronom logowania.",
  ...
  "admin.config.general.detect-language-from-browser":
    "Wykrywaj język z przeglądarki",
  "admin.config.general.detect-language-from-browser.description":
    "Dla gości, którzy jeszcze nie wybrali języka, użyj języka zgłoszonego przez ich przeglądarkę (języka systemu) zamiast domyślnego języka powyżej.",
  ...
  "admin.config.share.warn-anonymous-shares":
    "Ostrzegaj o udostępnieniach anonimowych",
  "admin.config.share.warn-anonymous-shares.description":
    "Pokazuj odwiedzającym ostrzeżenie, gdy udostępnienie zostało utworzone bez zalogowanego konta, i wymagaj krótkiego odliczania przed pobraniem jego plików.",
  "admin.config.share.warn-anonymous-shares-for-logged-in-users":
    "Ostrzegaj też zalogowanych użytkowników",
  "admin.config.share.warn-anonymous-shares-for-logged-in-users.description":
    "Pokazuj ostrzeżenie o anonimowym udostępnieniu również zalogowanym użytkownikom, a nie tylko anonimowym gościom. Wymaga włączenia powyższego ustawienia.",
  ...
  "admin.config.share.anonymous-warning-message.description":
    "Nadpisz wbudowany tekst ostrzeżenia o anonimowym udostępnieniu dla wybranego języka. Używany zarówno na banerze strony udostępnienia, jak i w oknie potwierdzenia pobierania. Zostaw puste, aby używać wbudowanego tłumaczenia.",
