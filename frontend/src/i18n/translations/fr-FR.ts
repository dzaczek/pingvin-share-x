export default {
  ...
  "share.anonymous-warning.banner.description": "Ce partage a été créé sans compte connecté. N'importe qui a pu déposer ces fichiers ici – traitez-les et ouvrez-les avec la même prudence que des fichiers venant d'internet.",
  ...
  "share.modal.anonymous-warning.description": "Ce fichier provient d'un partage anonyme – n'importe qui a pu le déposer ici sans vérification d'identité. Traitez-le avec la même prudence que les fichiers venant d'internet : ne l'utilisez pas à des fins financières et ne l'exécutez pas comme un programme.",
