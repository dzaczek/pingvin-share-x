export default {
  ...
  "share.anonymous-warning.banner.title": "Partage anonyme",
  "share.anonymous-warning.banner.description": "Personne n'était connecté lors de la création de ce partage, l'expéditeur n'est donc pas vérifié. Ces fichiers peuvent être du spam, une arnaque ou un logiciel malveillant comme un virus. Ne les téléchargez que si vous savez qui vous a envoyé ce lien et pourquoi.",
  ...
  "share.modal.anonymous-warning.title": "Ce partage est anonyme",
  "share.modal.anonymous-warning.description": "N'importe qui a pu déposer ce fichier ici, et rien ne confirme son identité. Il peut s'agir de spam, d'une arnaque ou d'une tentative d'hameçonnage, ou d'un logiciel malveillant comme un virus ou un rançongiciel. Ne l'ouvrez que si vous savez qui vous a envoyé ce lien et que vous attendiez ce fichier. Ne l'exécutez jamais comme programme ou script, n'activez jamais ses macros, et ne faites jamais confiance aux coordonnées de paiement, factures ou pages de connexion qu'il contient.",
  "share.modal.anonymous-warning.button.countdown": "Télécharger dans {seconds}s",
  "share.modal.anonymous-warning.button.ready": "Télécharger",
  ...
  "admin.config.share.warn-anonymous-shares": "Avertir pour les partages anonymes",
  "admin.config.share.warn-anonymous-shares.description": "Afficher un avertissement aux visiteurs lorsqu'un partage a été créé sans compte connecté, et exiger un court délai avant de télécharger ses fichiers.",
  "admin.config.share.warn-anonymous-shares-for-logged-in-users": "Avertir aussi les utilisateurs connectés",
  "admin.config.share.warn-anonymous-shares-for-logged-in-users.description": "Afficher aussi l'avertissement de partage anonyme aux utilisateurs connectés, pas seulement aux visiteurs anonymes. Nécessite que le réglage ci-dessus soit activé.",
  "admin.config.share.anonymous-warning-message": "Message d'avertissement personnalisé",
  "admin.config.share.anonymous-warning-message.description": "Remplacez le texte d'avertissement intégré pour les partages anonymes, pour une langue donnée. Utilisé à la fois dans la bannière de la page de partage et dans la fenêtre de confirmation du téléchargement. Laissez vide pour conserver la traduction intégrée.",
