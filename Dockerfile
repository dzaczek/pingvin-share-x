...
RUN npm run build && npx tsc prisma/seed/config.seed.ts --outDir dist/prisma/seed --rootDir prisma/seed --target es2021 --module commonjs --skipLibCheck && npm prune --omit=dev
